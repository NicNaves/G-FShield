...
public class KafkaIwssrConsumer {
    ...
    @KafkaListener(topics = TOPIC, groupId = "${spring.kafka.consumer.group-id}", containerFactory = "jsonKafkaListenerContainer", autoStartup = "${kafka.listener.auto-startup:true}")
