...
The contribution includes the implemented architecture and a formal campaign with 27 arms, eight seeds per arm, a stratified training/validation/test split, a common final evaluator, and a verifiable manifest. Corpus independence is architectural rather than experimental: input must be labeled tabular data compatible with the service contract. The evaluation covers only the ERENO corpus and J48 classifier.
