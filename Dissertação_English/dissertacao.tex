...
\setlength{\emergencystretch}{3em} % avoids margin overflow in long technical terms
...
% Babel is loaded by abntex2 through the document-class `english` option.
...
\usepackage{amsmath}        % Feature-selection metric equations
...
% ---------------------------------------------------------------------
% Para citações
\usepackage[english,hyperpageref]{backref} % Pages containing citations in the bibliography
...
\hypersetup{
  ...
  pdfkeywords={G-FShield}{Software Engineering}{Feature Selection}{Cyber-Physical Systems}{abntex},
...
\titulo{G-FShield: Distributed and Observable Feature Selection for Intrusion Detection in Cyber-Physical Systems}
\autor{Nícolas Naves Rezende Faria}
\local{Alegrete}
\data{2026}
\orientador[Advisor:]{Prof. Dr. Silvio E. Quincozes}
...
% The preamble must contain the type of work, the objective, the institution name and the area of concentration.
\preambulo{\imprimirtipotrabalho{} submitted to the Graduate Program in Software Engineering (PPGES) as a partial requirement for the degree of Master in Software Engineering.}
% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
%\listoffigures*
\newcommand{\lobname}{List of Abbreviations and Acronyms}
