...
A contribuição inclui a arquitetura implementada e uma campanha formal com 27 braços, oito sementes por braço, divisão estratificada de treino/validação/teste, avaliador final comum e manifesto verificável. A independência de corpus é arquitetural, não um resultado experimental: a entrada deve ser tabular, rotulada e compatível com o contrato dos serviços. A avaliação cobre apenas o corpus ERENO e o classificador J48.
