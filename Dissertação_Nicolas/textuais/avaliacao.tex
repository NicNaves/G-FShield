...
\textbf{Validade interna.} CPU, memória, conjunto de CPUs, dados, sementes, limite, J48 e F1 macro foram controlados. Entretanto, os comparadores não executam a mesma sequência algorítmica: o G-FShield selecionado usa RF--VND--IWSSR, o Monólito~1 usa GR--BF e o Monólito~2 usa GR--IWSS. A campanha também não alternou a ordem de execução nem registrou uma trajetória cumulativa equivalente de candidatos nos monólitos. Essas diferenças impedem atribuir os resultados somente à arquitetura. As 12 tentativas sem solução completa foram rejeitadas e repetidas; esse mecanismo pode favorecer execuções que conseguem inicializar, embora preserve a matriz de sementes válidas.
