...
Os resultados demonstram integração arquitetural, rastreabilidade experimental e diferenças descritivas, não causalidade arquitetural, escalabilidade ou tolerância a falhas. O objetivo interno legado do G-FShield ainda difere do F1 macro usado pelos monólitos durante a busca, e as classes \textit{grayhole} e \textit{normal} permanecem mais difíceis. Completude e custo da telemetria, recuperação, reprocessamento, escala horizontal e generalização para outros dados e classificadores requerem experimentos específicos.
