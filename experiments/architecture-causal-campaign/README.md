...
monolith receives that same aggregate ceiling. It is designed to test an architectural effect;
...
primary outcome is the end-to-end time required to first reach validation
macro-F1 0.94, censored at the 2,700-second selection deadline. Held-out
...
python3 experiments/architecture-causal-campaign/run_campaign.py \
  ...
  --campaign-tag experiment-architecture-causal-v1 \
