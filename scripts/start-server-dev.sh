...
ROOT_PRESET_COMPOSE_FILE="${REPO_ROOT}/docker-compose.server.yml"
...
echo "Subindo stack server do GF-Shield..."
invoke_compose "$REPO_ROOT" "${ROOT_COMPOSE_ARGS[@]}"

echo "Subindo banco server do webservice/api..."
